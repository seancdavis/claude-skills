---
name: file-storage
description: File upload and storage patterns using Netlify Blobs. Use when implementing file uploads, storing non-image files, or retrieving stored files. For image-specific handling with CDN optimization, see the netlify-images skill instead.
---

# File Storage

File upload and storage patterns using Netlify Blobs.

---

## When to Use This Skill

- Storing documents, PDFs, or other non-image files
- Simple file storage without CDN transformation needs
- When you need the raw file back without processing
